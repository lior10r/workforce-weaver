...
import { Employee, WorkforceEvent, DEPARTMENTS, Hierarchy } from '@/lib/workforce-data';
...
export const Dashboard = ({ employees, events, hierarchy, setHierarchy }: DashboardProps) => {
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 animate-fade-in">
      ...
      <div className="lg:col-span-2 space-y-8">
        <div className="glass-card p-8">
          <h3 className="text-xl font-bold mb-6 text-foreground">Department Distribution</h3>
          <div className="space-y-5">
            {(DEPARTMENTS[hierarchy.group] || []).map(dept => {
              ...
              return (
                <div 
                  ...
                  onClick={() => setHierarchy({...hierarchy, dept})}
                >
