...
import { Loader2, Users, AlertCircle, Server } from 'lucide-react';
      ...
      <div className="min-h-screen flex items-center justify-center bg-background p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardTitle>Backend Not Available</CardTitle>
            <CardDescription>
    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle>Workforce Planner</CardTitle>
          <CardDescription>
